...
The idea of creating Arduino took shape in 2003 at the Interaction Design Institute Ivrea (IDII) in Italy. The idea was to build a simple, low-cost device for students to carry out digital projects, especially those who did not have much familiarity with the principles of engineering and programming. Three key individuals played a role in realizing this idea: Hernando Barragán, Massimo Banzi, and Casey Reas.
